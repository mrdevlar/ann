...
for n_training  = ns_training
for n_neurons   = ns_neurons
for l_noise     = ls_noise
for i = 1:size(algos,1)
    train_algo  = algos{i};
for q_validate  = early_stop;
for q_regular   = regular    
for c_regular   = qs_regular
